...
.logo-panel{background:#1A1F2E;border:1px solid #374151;border-radius:8px;padding:0.4rem;text-align:center;margin-bottom:0.3rem;}
.logo-panel img{height:120px;}
...
### Mission
9 Cr+ filers. ₹3.9L Cr refunds. Most Indians overpay. TaxGuru fixes this.

### How It Works
**🧮 Precise Engine** — Deterministic math. Always exact. **🤖 {A}** — 60 tax law entries, CBDT circulars, case law. Cites sections. **🔍 Real-Time** — Searches for latest developments. **📄 Document AI** — Reads payslips/Form 16. **🔒 Privacy** — No PAN/Aadhaar/DOB/phone/email/bank. Session-only.

### Accuracy
60 provisions. CBDT Notification 22/2026. Auto-updates weekly.
